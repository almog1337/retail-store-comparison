...
def upload_data_to_uploader(records: list, pipeline_name: str, create_bucket: bool) -> None:
    """Upload records to the uploader service. Key is auto-generated by the uploader."""
    uploader_url = os.environ.get("UPLOADER_URL", "http://localhost:8000/s3")
...
class PipelineRunner:
    ...
    def run_and_upload(
        ...
        if parsed_records:
            ...
            # Upload grouped records (key is auto-generated by uploader service)
